...
Zestawienie w tabeli \ref{tab:iou_scenarios} pokazuje, ¿e najwy¿sze œrednie wartoœci IoU uzyskiwane s¹ w scenariuszach dziennych przy dobrym oœwietleniu. W przejazdach realizowanych w warunkach \textit{dzieñ, s³oñce} na mapach Town03 i Town04 œrednie IoU osi¹ga wartoœci rzêdu 0{,}74--0{,}76, przy porównywalnej liczbie klatek analizowanych w ka¿dym scenariuszu. Wynika to z równomiernego oœwietlenia sceny, wyraŸnych konturów pojazdów oraz ograniczonego wp³ywu odbiæ œwiat³a na nawierzchni, co sprzyja zarówno poprawnemu wyznaczaniu ramek w CARLA, jak i ich póŸniejszemu odtworzeniu przez YOLOv4.

W scenariuszach nocnych oraz podczas intensywnych opadów deszczu œrednie IoU wyraŸnie spada do poziomu oko³o 0{,}56--0{,}64. Ograniczona widocznoœæ, silne kontrasty pomiêdzy oœwietlonymi a zacienionymi fragmentami oraz odbicia œwiate³ reflektorów na mokrej jezdni utrudniaj¹ poprawne wyznaczenie granic obiektów. Dodatkowo, przy wysokiej liczbie aktorów w scenie pojazdy czêsto nachodz¹ na siebie, co powoduje czêœciowe przes³anianie i skutkuje ni¿szymi wartoœciami IoU dla czêœci klatek, mimo ¿e obiekty s¹ wykrywane. Ró¿nice pomiêdzy mapami Town03 i Town04 s¹ niewielkie i wynikaj¹ g³ównie z odmiennej geometrii œrodowiska oraz innego rozk³adu skrzy¿owañ, co wp³ywa na czêstoœæ wystêpowania sytuacji z silnym zas³anianiem siê pojazdów.
...
Skrypt \texttt{yolo.py} realizuje detekcjê obiektów na zapisanych wczeœniej obrazach z kamery, korzystaj¹c z biblioteki \texttt{ultralytics} i modelu YOLOv8. Wyniki detekcji zapisywane s¹ w plikach JSON w strukturze zbli¿onej do formatu stosowanego przez \texttt{bounding\_boxes.py}, co u³atwia póŸniejsz¹ ewaluacjê.
