...
Pogoda w symulatorze CARLA nie jest reprezentowana jako odrêbna klasa, lecz jako zbiór parametrów œrodowiskowych dostêpnych w œwiecie symulacji. Parametry te obejmuj¹ m.in. po³o¿enie s³oñca, stopieñ zachmurzenia, si³ê wiatru, mg³ê, deszcz, œnieg oraz inne czynniki, co umo¿liwia testowanie aplikacji w szerokim zakresie warunków atmosferycznych. Aby zdefiniowaæ w³asn¹ pogodê u¿ywa siê klasy pomocniczej \verb|carla.WeathrrParameters| \\
...
\begin{itemize}
	\item \textbf{Main Loop - game\_loop()} – odpowiada za przetwarzanie zdarzeñ wejœciowych, aktualizacjê stanu œwiata oraz renderowanie grafiki.
