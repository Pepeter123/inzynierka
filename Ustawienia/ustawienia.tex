...
% Domyœlnie prosty styl (bez nag³ówka) – wstêp
\pagestyle{plain}
...
%\bibliographystyle{plain}					% kolejnoœæ alfabetyczna
...
% Inne deklaracje
%==========================================================================================
\renewcommand{\lstlistlistingname}{Spis listingów\vspace*{10pt}}
...
\lstdefinestyle{pythonColor}{
	...
	stepnumber=1,
	numbersep=10pt,
	backgroundcolor=\color{white}, % bia³e t³o
	frame=tb,                      % ramka tylko góra/dó³
	breaklines=true,
	showstringspaces=false,
	captionpos=b,
	emphstyle=\color{violet} % <- kolor funkcji
}